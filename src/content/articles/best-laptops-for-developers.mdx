...
import image3 from '$lib/content/img/image3.png'
...
<Picture
  ...
  class="rounded-lg"
  formats={['avif', 'webp']}
  widths={[375, 425, 768, 1024, 1400, image3.width]}
  sizes={`(max-width: 375px) 375px, (max-width: 425px) 425px, (max-width: 768px) 768px, (max-width: 1024px) 1024px, (max-width: 2560px) 1400px, ${image3.width}px`}
/>
